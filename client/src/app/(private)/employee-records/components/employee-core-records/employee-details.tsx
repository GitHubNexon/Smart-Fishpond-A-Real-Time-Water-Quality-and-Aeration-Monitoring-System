    ...
    >
      <div className="h-[75vh] flex flex-col">
                ...
                <AvatarImage
                  src={
                    emp.user?.profileImage
                      ? emp.user.profileImage
                      : `https://api.dicebear.com/7.x/initials/svg?seed=${emp.personalInfo.firstName} ${emp.personalInfo.lastName}`
                  }
                />
                <AvatarFallback className="text-lg font-semibold bg-linear-to-br from-blue-500 to-purple-600 text-white">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid sm:grid-cols-2 gap-3 text-sm">
                ...
                <div className="flex items-center gap-2.5 text-muted-foreground">
                  ...
                  <span>{emp.contactInfo.contactNo}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center mb-2">
          <button
            onClick={() => router.push(`/employee-info/${emp.employeeId}`)}
